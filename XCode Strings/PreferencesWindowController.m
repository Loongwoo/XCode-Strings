...
- (void)loadWindow {
    ...
    [self.dirTitleTextField setStringValue:NSLocalizedString(@"SearchDirectory", nil)];
    [self.tableTitleTextField setStringValue:NSLocalizedString(@"SearchTableName", nil)];
    [self.languageLabel setStringValue:NSLocalizedString(@"DevLanguage", nil)];
    [self.languageTipsLabel setStringValue:NSLocalizedString(@"DevLanguageTips", nil)];
    [self.wrapperTitleField setStringValue:NSLocalizedString(@"Wrapper", nil)];
    [self.wrapperTipsField setStringValue:NSLocalizedString(@"WrapperTips", nil)];
    [self.searchNumberLabel setStringValue:NSLocalizedString(@"SearchNumber", nil)];
...
-(void)endEditingAction:(NSNotification*)notification {
    if([notification object] == self.tableNameTextField){
        ...
        if(![extension isEqualToString:@"strings"]) {
            ...
            [alert setMessageText: NSLocalizedString(@"FileExtensionInvalid", nil)];
